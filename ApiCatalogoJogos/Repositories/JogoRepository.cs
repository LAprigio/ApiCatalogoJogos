...
namespace ApiCatalogoJogos.Repositories
{
    public class JogoRepository: IJogoRepository
    {
        private static Dictionary<Guid, Jogo> jogos = new Dictionary<Guid, Jogo>()
        {
            ...
            {Guid.Parse("5e99c84a-108b-4dfa-ab7e-d8c55957a7ec"), new Jogo{Id = Guid.Parse("5e99c84a-108b-4dfa-ab7e-d8c55957a7ec"), Nome = "PES 2021", Produtora = "Konami", Preco = 190} },
            {Guid.Parse("da033439-f352-4539-879f-515759312d53"), new Jogo{Id = Guid.Parse("da033439-f352-4539-879f-515759312d53"), Nome = "Need For Speed", Produtora = "EA Sports", Preco = 230} }
        };
